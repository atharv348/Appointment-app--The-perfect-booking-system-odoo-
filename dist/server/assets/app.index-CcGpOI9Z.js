...
import { f as fmtMoney, a as fmtDateTime } from "./format-CCH22ipv.js";
...
import { f as filterProps, L as Layer, m as max, i as isNumber, C as Curve, A as Animate, a as interpolateNumber, b as isNil, c as isNan, h as hasClipDot, d as LabelList, u as uniqueId, e as isFunction, G as Global, g as getValueByDataKey, j as getCateCoordinateOfLine, D as Dot, k as generateCategoricalChart, X as XAxis, Y as YAxis, l as formatAxisMap, T as TrendingUp, R as ResponsiveContainer, n as CartesianGrid, o as Tooltip } from "./generateCategoricalChart-DfzloDQE.js";
...
function Overview() {
  ...
  const monthRevenue = payments.filter((p) => new Date(p.created_at) >= monthStart).reduce((sum, p) => sum + p.amount_cents, 0);
  const chart = Array.from({
    length: 14
  }).map((_, i) => {
    const d = new Date(todayStart.getTime() - (13 - i) * 864e5);
  ...
  const upcoming = appts.filter((a) => new Date(a.start_at) >= now).slice(0, 5);
  const stats = [{
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "A snapshot of your studio." })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 lg:grid-cols-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "lg:col-span-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Revenue · last 14 days" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "h-72", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AreaChart, { data: chart, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "rev", x1: "0", y1: "0", x2: "0", y2: "1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "5%", stopColor: "var(--color-primary)", stopOpacity: 0.4 }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { dataKey: "date", stroke: "var(--color-muted-foreground)", fontSize: 11 }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Area, { type: "monotone", dataKey: "revenue", stroke: "var(--color-primary)", fill: "url(#rev)" })
        ] }) }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Upcoming" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-3", children: [
          upcoming.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "No upcoming appointments." }),
          upcoming.map((a) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between border-b pb-3 last:border-0 last:pb-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium", children: a.customer?.name ?? "Walk-in" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: a.service?.name ?? "Service" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-xs text-muted-foreground", children: fmtDateTime(a.start_at) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: a.status })
          ] }, a.id))
        ] })
      ] })
    ] })
