...
import { P as getDefaultExportFromCjs, r as reactExports, T as React } from "./worker-entry-CW2L5Pfm.js";
import { r as requireGet, a as require_baseGetTag, b as requireIsArray, c as requireIsObjectLike, d as requireIsFunction, e as requireIsObject, f as require_baseSlice, g as requireToString, h as require_baseFindIndex, j as require_Set, k as require_setToArray, l as require_SetCache, m as require_cacheHas, n as require_baseIteratee, s as sortBy, o as require_root, p as requireToNumber, q as requireIsSymbol, t as requireIdentity, u as require_baseMap, v as require_arrayMap, w as require_baseFlatten, i as isEqual$1, x as requireLast, P as PropTypes, y as requireIsPlainObject, z as range$1$1, A as require_baseEach, B as require_arraySome, C as require_isIterateeCall, D as mapValues, E as requireIsArrayLike, F as requireKeys, G as requireFindIndex, H as requireMemoize } from "./findIndex-J_DBwaH3.js";
import { i as invariant } from "./tiny-invariant-BVT9pohb.js";
const __iconNode = [
...
var createScale = function createScale2(_ref) {
  ...
  var len = data.length;
  var scale = point().domain(range$1$1(0, len)).range([x2, x2 + width - travellerWidth]);
