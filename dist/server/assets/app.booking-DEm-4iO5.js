import { a0 as requireReact, r as reactExports, T as React, U as jsxRuntimeExports } from "./worker-entry-CW2L5Pfm.js";
import { o as ReactDOM, r as reactDomExports, u as useNavigate, a as useQueryClient, t as toast } from "./router-GsH7DwrS.js";
...
import { i as invariant$1 } from "./tiny-invariant-BVT9pohb.js";
...
function useMouseSensor(api2) {
  ...
  const startCaptureBinding = useMemo(() => ({
    ...
    fn: function onMouseDown(event) {
      ...
      const draggableId = api2.findClosestDraggableId(event);
      if (!draggableId) {
        return;
      }
      const actions = api2.tryGetLock(draggableId, stop, {
        sourceEvent: event
      });
      if (!actions) {
        return;
  ...
  const preventForcePressBinding = useMemo(() => ({
    ...
    fn: (event) => {
      ...
      const id = api2.findClosestDraggableId(event);
      if (!id) {
        return;
      }
      const options = api2.findOptionsForDraggable(id);
      if (!options) {
        return;
      }
...
function useKeyboardSensor(api2) {
  ...
  const startCaptureBinding = useMemo(() => ({
    ...
    fn: function onKeyDown(event) {
      ...
      const preDrag = api2.tryGetLock(draggableId, stop, {
        sourceEvent: event
      });
      if (!preDrag) {
        return;
...
const defaultQuestions = ["How did you hear about us?", "Any allergies or sensitivities?", "Preferred contact method?", "Anything we should know in advance?"];
function Booking() {
  ...
  const [questions, setQuestions] = reactExports.useState(defaultQuestions);
  const [answers, setAnswers] = reactExports.useState({});
  const service = reactExports.useMemo(() => services.find((s) => s.id === serviceId), [services, serviceId]);
  const create2 = useMutation({
    mutationFn: async () => {
      ...
      const start = /* @__PURE__ */ new Date(`${date}T${time}`);
      const end2 = new Date(start.getTime() + (service?.duration_minutes ?? 30) * 6e4);
...
${answers[i]}` : "").filter(Boolean).join("\n\n");
  ...
  const canNext = step === 0 && !!serviceId || step === 1 && (!!customerId || newCustomer.name.length > 0) || step === 2 && !!date && !!time || step === 3 || step === 4;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-3xl space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold tracking-tight", children: "New booking" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Build the booking step by step." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2", children: steps.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `flex h-8 w-8 items-center justify-center rounded-full border text-xs font-medium ${i <= step ? "border-primary bg-primary text-primary-foreground" : "border-border bg-muted text-muted-foreground"}`, children: i < step ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "h-4 w-4" }) : i + 1 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `ml-2 hidden text-xs sm:inline ${i === step ? "font-medium" : "text-muted-foreground"}`, children: s }),
      i < steps.length - 1 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-2 h-px flex-1 bg-border" })
    ] }, s)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: steps[step] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-4", children: [
        step === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-3 sm:grid-cols-2", children: [
          services.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "No services yet. Add one in Services first." }),
          services.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setServiceId(s.id), className: `rounded-lg border p-4 text-left transition ${serviceId === s.id ? "border-primary ring-2 ring-primary/20" : "hover:border-foreground/30"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: fmtMoney(s.price_cents) })
          ] }) }, s.id))
        ] }),
        step === 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Existing customer" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: customerId, onValueChange: (v) => {
              setCustomerId(v);
              setNewCustomer({
                name: "",
                email: "",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center text-xs text-muted-foreground", children: "— or create new —" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { placeholder: "Name", value: newCustomer.name, onChange: (e) => {
              setNewCustomer({
                ...newCustomer,
                name: e.target.value
              });
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { placeholder: "Email", value: newCustomer.email, onChange: (e) => setNewCustomer({
              ...newCustomer,
              email: e.target.value
            }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { placeholder: "Phone", value: newCustomer.phone, onChange: (e) => setNewCustomer({
              ...newCustomer,
              phone: e.target.value
            }) })
          ] })
        ] }),
        step === 2 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-3 sm:grid-cols-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        ...
        step === 3 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Drag to reorder. Answers are optional." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(DragDropContext, { onDragEnd: onDragEnd2, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ConnectedDroppable, { droppableId: "q", children: (p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: p.innerRef, ...p.droppableProps, className: "space-y-2", children: [
            questions.map((q, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(PublicDraggable, { draggableId: q, index: i, children: (prov) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: prov.innerRef, ...prov.draggableProps, className: "flex gap-2 rounded-lg border bg-card p-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ...prov.dragHandleProps, className: "mt-2 text-muted-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsx(GripVertical, { className: "h-4 w-4" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: q }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: answers[i] ?? "", onChange: (e) => setAnswers({
                  ...answers,
                  [i]: e.target.value
                }), className: "mt-1" })
              ] })
        ...
        step === 4 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { label: "Service", value: service ? `${service.name} · ${fmtMoney(service.price_cents)}` : "—" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { label: "Customer", value: customerId ? customers.find((c) => c.id === customerId)?.name ?? "—" : newCustomer.name || "—" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { label: "Date", value: date && time ? `${date} at ${time}` : "—" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { label: "Duration", value: `${service?.duration_minutes ?? 30} min` })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", disabled: step === 0, onClick: () => setStep((s) => s - 1), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronLeft, { className: "h-4 w-4" }),
        " Back"
      ] }),
      step < steps.length - 1 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { disabled: !canNext, onClick: () => setStep((s) => s + 1), children: [
        "Next ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "h-4 w-4" })
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { disabled: create2.isPending, onClick: () => create2.mutate(), children: create2.isPending ? "Creating…" : "Confirm booking" })
    ] })
  ] });
}
function Row({
